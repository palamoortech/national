...
def app():
    ...
    with title:
        st.title('Indian national elections vizualisation tool')
        st.markdown("""
            This app performs simple vizualisation from some open data available on loksabha portal!
            The data used are for the period June 1962 to March 2021 (Prime Minister Mr.Narendra Modi)
